...
dthv=[5, 10, 15]; % overtwist values (degrees)
...
saveas(axh,'fig_kn_pull_bs.fig')
saveas(axh,'fig_kn_pull_bs.pdf')


return

saveas(axh,'fig_kn_dthv.pdf')
saveas(axh2,'fig_kn_dthv_delta.pdf')
