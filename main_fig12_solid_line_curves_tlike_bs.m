...
ksr=0.0005; % angular spring constant scaling
...
[nodes,edges,wedges,stypes,wtypes]=...
    genmodtnw(n,a,b,h,dth,or);
...
saveas(axh,'fig_kn_tlike_bs.fig')
saveas(axh,'fig_kn_tlike_bs.pdf')
