...
delta=0.14; % dimensionless change in height

y1=-0.002; y2=0.004; %ylim
...
vv=[0.5, 0.75, 1, 1.25, 1.5]; % values of b-to-a ratio
...
saveas(axh,'fig_kn_b2a_bs.fig')
saveas(axh,'fig_kn_b2a_bs.pdf')
