...
epsv=[0, 0.001, 0.002, 0.005, 0.010];
...
lgd=legend(axh,num2str(epsv','%1.3f'),'Location','Northeast');
disp([' ']); disp(['Figure: force-vs-displacement plot']);
lgd=legend(axh2,num2str(dd','%1.3f'),'Location','Northeast');

lgd=legend(axh3,num2str(epsv','%1.3f'),'Location','Northwest');

saveas(axh,'fig_kn_flat6_ps.pdf')
saveas(axh,'fig_kn_flat6_ps.fig')
