...
lgd=legend(axh,num2str(dthv','%2.0f'),'Location','Southwest');
disp([' ']); disp(['Figure: force-vs-displacement plot']);
lgd=legend(axh2,num2str(dd','%1.3f'),'Location','Southwest');


saveas(axh,'fig_kn_base_bs.fig')
saveas(axh,'fig_kn_base_bs.pdf')
saveas(axh2,'fig_kn_base_bs_delta.fig')
saveas(axh2,'fig_kn_base_bs_delta.pdf')
